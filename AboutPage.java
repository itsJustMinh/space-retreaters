...
public class AboutPage extends World
{
    ...
    private void prepare()
    {
        ...
        aboutPageDescription2 = new Label("the left and right keys, along with the \n\"a\" and \"d\" keys are for moving the    \n" +
                                           "player left and right                               ", 15);
        aboutPageDescription3 = new Label("the \"u\" key is to return to the menu      ", 15);
        addObjects();
    }
    public void addObjects()
    {
        ...
        addObject(aboutPageDescription2, getWidth()/2, getHeight()/2 + 110);
        addObject(aboutPageDescription3, getWidth()/2, getHeight()/2 + 150);
        //icons for reference
